...
@Getter @Setter
public class EducationLevelTraining {
	@Getter @Setter
	private List<Training> trainingLst;
	@Getter @Setter
	...
	public List<Training> getTrainingLst() {
		return trainingLst;
	}
	public void setTrainingLst(List<Training> trainingLst) {
		this.trainingLst = trainingLst;
	}
